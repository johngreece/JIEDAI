...
const typeTone: Record<string, string> = {
  ...
  REPAYMENT_PENDING_RECEIPT: "bg-blue-100 text-blue-700",
  REPAYMENT_RECEIVED_CONFIRMED: "bg-emerald-100 text-emerald-700",
  REPAYMENT_REJECTED: "bg-rose-100 text-rose-700",
