    ...
    <div className="space-y-6">
      <header className="panel-soft admin-page-header">
        <div className="admin-page-header__meta">
          ...
          <p className="admin-page-header__description">集中处理借款申请流转、风控审核、审批动作和放款前状态追踪。</p>
        </div>
      ...
      <section className="table-shell admin-table-shell">
        <div className="admin-table-toolbar">
          ...
          <div className="text-xs font-medium text-slate-500">当前筛选: {status === "ALL" ? "全部" : statusText(status)}</div>
        </div>
