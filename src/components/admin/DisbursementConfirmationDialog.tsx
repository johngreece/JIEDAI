...
export function DisbursementConfirmationDialog({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="confirm-disbursement-title"
    >
      <form
        onSubmit={submit}
      ...
      >
        <div className="border-b border-slate-200 px-5 py-4">
          <h2 id="confirm-disbursement-title" className="text-base font-semibold text-slate-900">
            Confirm bank transfer
          </h2>
          <p className="mt-1 text-sm text-slate-500">{disbursementNo}</p>
        </div>
